...
@Component({
  selector: 'app-re-entry-header',
  templateUrl: './re-entry-header.component.html'
})
export class ReEntryHeaderComponent implements OnInit, OnDestroy {
