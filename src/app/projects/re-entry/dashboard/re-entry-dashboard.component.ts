...
import { fadeInAnimation } from 'src/app/animation-effect/index';
...
@Component({
  ...
  templateUrl: './re-entry-dashboard.component.html',
  animations: [fadeInAnimation],
  host: { '[@fadeInAnimation]': '' }
})
export class ReEntryDashboardComponent implements OnInit {
